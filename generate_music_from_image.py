...
if __name__ == "__main__":
    ...
    video_length = flame_extract(video_name,flame_interval,picture_dir)
    ...
    os.system("ffmpeg -i temp.mp4 -i "+output_dir+"GenerateMusic_all_guitar.wav -vcodec copy -acodec copy output_all_guitar.avi -y")
    os.system("ffmpeg -i temp.mp4 -i "+output_dir+"GenerateMusic_all_piano.wav -vcodec copy -acodec copy output_all_piano.avi -y")
    os.system("ffmpeg -i temp.mp4 -i "+output_dir+"GenerateMusic_mix_guitar_and_piano.wav -vcodec copy -acodec copy output_mix_guitar_and_piano.avi -y")
    os.remove("temp.mp4")
    print "end****************************"
